...
for (yr in 1920:2012) {
  s=stack()
  #Set working directory based on SPI time period
  wdpath<-paste("D:/LaptopBackupFULL_04262017/AbbyF/SPI_Grid_Analysis/SPI_Grids/HI_SPI_Outputs/250m/",spitime,"mo_SPI",sep="")
  setwd(wdpath)
...
setwd("D:/LaptopBackupFULL_04262017/AbbyF/SPI_Grid_Analysis/SPI_MapTimeSeries/IslandTimeSeries")
